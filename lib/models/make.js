...
var esURL = env.get( "FOUNDELASTICSEARCH_URL" ),
    esPort,
    esHost;

if ( esURL ) {
  esURL = url.parse( esURL );
  esHost = esURL.hostname;
  esPort = esURL.port;
}

schema.plugin( mongoosastic, {
  port: esPort || env.get( "elastic_search_port" ) || 9200,
  host: esHost || env.get( "elastic_search_host" ) || "localhost",
  hydrate: true
});
