...
app.post( "/api/make", middleware.authenticateUser, Mongo.isDbOnline, middleware.prefixAuth, routes.create );
app.put( "/api/make/:id", middleware.authenticateUser, Mongo.isDbOnline, middleware.prefixAuth, routes.update );
app.del( "/api/make/:id", middleware.authenticateUser, Mongo.isDbOnline, routes.remove );
